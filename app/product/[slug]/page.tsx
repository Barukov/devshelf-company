...
export default function ProductPage() {
  ...
  return (
    <main className="min-h-screen bg-[#eafff6] text-[#071b18]">
      <section className="bg-[#082f2a] px-8 py-8 text-white">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-14 py-20 lg:grid-cols-2">
          <div>
            <p className="font-bold text-[#5eead4]">{product.tag}</p>
            ...
            <p className="mt-8 text-6xl font-black text-[#5eead4]">
              {product.price}
            </p>
            ...
            <div className="mt-8 flex gap-4">
              <button
                onClick={() => setCart(true)}
                className="rounded-2xl bg-[#f9735b] px-9 py-4 font-bold"
              >
                Add to cart
              </button>
      ...
      <section id="details" className="px-8 py-24">
        <div className="mx-auto max-w-7xl">
          <h2 className="text-5xl font-black">
            What’s inside <span className="text-[#0f9f8f]">the pack?</span>
          </h2>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 flex items-center justify-between border-t bg-white p-4">
        ...
        <button
          onClick={() => setCart(true)}
          className="rounded-xl bg-[#f9735b] px-6 py-3 font-bold text-white"
        >
          Buy now
        </button>
      </div>
