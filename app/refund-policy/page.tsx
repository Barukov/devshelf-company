...
<section><h2 className="text-2xl font-black text-[#16130f]">14-day refund window</h2><p className="mt-2">Refund requests may be submitted within 14 days of purchase. Requests are reviewed based on delivery status, product access, duplicate purchases, payment issues and abuse prevention.</p></section>
<section><h2 className="text-2xl font-black text-[#16130f]">How to request a refund</h2><p className="mt-2">Contact support@devshelf.company with the email used at checkout, transaction ID if available, product name and reason for the request.</p></section>
<section><h2 className="text-2xl font-black text-[#16130f]">Processing time</h2><p className="mt-2">Approved refunds are processed through the original payment method. Depending on the bank or payment provider, funds may take 5-10 business days to appear.</p></section>
<section><h2 className="text-2xl font-black text-[#16130f]">Limitations</h2><p className="mt-2">Refunds may be refused for resale, redistribution, unauthorized sharing, abusive repeat requests or attempts to access digital files and reverse the payment unfairly.</p></section></div>
