...
<section><h2 className="text-2xl font-black text-[#16130f]">2. Digital products</h2><p className="mt-2">DevShelf Academy sells downloadable programming study materials, including PDF books, course files, C# resources, .NET notes, ASP.NET Core learning files, exercises, templates and related digital resources. No physical goods are shipped.</p></section>
